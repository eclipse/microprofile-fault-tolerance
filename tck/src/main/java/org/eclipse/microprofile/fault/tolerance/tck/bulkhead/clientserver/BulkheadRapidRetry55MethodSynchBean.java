...
public class BulkheadRapidRetry55MethodSynchBean implements BulkheadTestBackend {
    ...
    @Asynchronous
    @Retry(retryOn =
    { BulkheadException.class }, delay = 1, delayUnit = ChronoUnit.MILLIS, maxRetries = 10)
