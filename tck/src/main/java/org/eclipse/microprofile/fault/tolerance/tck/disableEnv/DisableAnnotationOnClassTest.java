 ...
 * Fault Tolerance API. All Fault tolerance policies are disabled through configuration on the DisabledClient.
 *
...
public class DisableAnnotationOnClassTest extends Arquillian {
    ...
    public static WebArchive deploy() {
        JavaArchive testJar = ShrinkWrap
            ...
            .addAsManifestResource(
                new StringAsset("org.eclipse.microprofile.fault.tolerance.tck.disableEnv.DisableClient/Retry/enabled=false\n" +
     ...
     *
     * ServiceA is annotated with maxRetries = 1 
     * so serviceA is expected to execute 2 times 
     * but as Retry is disabled, then no retries should be attempted.
     */
    @Test
