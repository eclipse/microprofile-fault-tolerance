...
public class RetryMetricTest extends Arquillian {
    ...
    public void testRetryMetricNonRetryableImmediately() {
        ...
        expectThrows(NonRetryableException.class, () -> retryBean.failSeveralTimesThenNonRetryable(0, new CallCounter()));
        ...
        assertThat("invocations throwing exception", m.getInvocations(EXCEPTION_THROWN, InvocationFallback.NOT_DEFINED).delta(), is(1L));
    }
    ...
    public void testRetryMetricNonRetryableAfterRetries() {
        ...
        expectThrows(NonRetryableException.class, () -> retryBean.failSeveralTimesThenNonRetryable(3, new CallCounter()));
    ...
    public void testRetryMetricMaxDuration() {
        ...
        expectTestException(() -> retryBean.failAfterDelay(testDelay)); // Should retry ~10 times, then reach max duration
    ...
    public void testRetryMetricMaxDurationNoRetries() {
        ...
        expectTestException(() -> retryBean.failAfterDelay(testDelay)); // Should fail after first attempt due to reaching maxDuration
