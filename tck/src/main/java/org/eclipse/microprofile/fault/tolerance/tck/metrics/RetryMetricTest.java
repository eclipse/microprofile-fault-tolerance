...
public class RetryMetricTest extends Arquillian {
    ...
    public void testRetryMetricSuccessfulImmediately() {
        ...
        retryBean.failSeveralTimes(0); // Should succeed on first attempt
    ...
    public void testRetryMetricSuccessfulAfterRetry() {
        ...
        retryBean.failSeveralTimes(3); // Should retry 3 times, and eventually succeed
    ...
    public void testRetryMetricUnsuccessful() {
        ...
        expectTestException(() -> retryBean.failSeveralTimes(20)); // Should retry 5 times, then fail
        expectTestException(() -> retryBean.failSeveralTimes(20)); // Should retry 5 times, then fail
