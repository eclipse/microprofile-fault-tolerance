...
public class DisableAnnotationOnMethodsTest extends Arquillian {
    ...
    public static WebArchive deploy() {
        JavaArchive testJar = ShrinkWrap
            ...
            .addAsManifestResource(
                new StringAsset("org.eclipse.microprofile.fault.tolerance.tck.disableEnv.DisableClient/serviceA/Retry/enabled=false\n" +
     ...
     *
     * ServiceA is annotated with maxRetries = 1 so serviceA is expected to execute 2 times 
