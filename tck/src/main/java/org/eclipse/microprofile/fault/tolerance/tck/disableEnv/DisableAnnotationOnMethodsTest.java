...
public class DisableAnnotationOnMethodsTest extends Arquillian {
    ...
    public static WebArchive deploy() {
        JavaArchive testJar = ShrinkWrap
            ...
            .addAsManifestResource(new StringAsset("org.eclipse.microprofile.fault.tolerance.tck.disableEnv.DisableClient/serviceA/Retry/enable=false\n" +
                                                       "org.eclipse.microprofile.fault.tolerance.tck.disableEnv.DisableClient/serviceB/Fallback/enable=false\n" +
                                                       "org.eclipse.microprofile.fault.tolerance.tck.disableEnv.DisableClient/serviceC/CircuitBreaker=false\n" +
                                                       "org.eclipse.microprofile.fault.tolerance.tck.disableEnv.DisableClient/serviceD/Timeout=false\n" +
