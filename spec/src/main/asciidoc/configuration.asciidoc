...
For an instance, the property `com.acme.ClassA/methodB/Retry/maxRetries` will be ignored if `Retry` annotation is not specified on the `methodB` of `com.acme.ClassA`. 
